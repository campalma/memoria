...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('visualization_article', 'category')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Article.category'
        raise RuntimeError("Cannot reverse this migration. 'Article.category' and its values cannot be restored.")
